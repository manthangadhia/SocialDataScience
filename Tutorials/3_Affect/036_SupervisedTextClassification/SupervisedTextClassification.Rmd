...
```
Seems that when a tweet is predicted as angry, it has high chances to be truly angry, but tweets predicted as not angry might be both angry and not. We can measure this better if we calculate accuracy, precision, and recall:
