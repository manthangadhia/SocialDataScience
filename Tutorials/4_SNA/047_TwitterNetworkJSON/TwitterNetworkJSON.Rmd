...
```{r}
poldf <- read.csv("C:/Users/manth/GitHub/SocialDataScience/Exercises/04_Assortativity_Twitter/SwissPoliticians.csv",sep="\t",header=TRUE, stringsAsFactors=FALSE)
...
```{r}
lines <- readLines(gzfile("C:/Users/manth/GitHub/SocialDataScience/Exercises/04_Assortativity_Twitter/SwissPoliticians-tweets.json.gz"))
